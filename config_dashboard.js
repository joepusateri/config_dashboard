...
(function() {
  ...
  function getIVAInfo(config)
  {
    ...
    if (min_level.value == 1)
    {
       ...
       // print("IVA DEBUG is turned ON " + ("(default)" if (min_level['source'] == 'default') else ""))
